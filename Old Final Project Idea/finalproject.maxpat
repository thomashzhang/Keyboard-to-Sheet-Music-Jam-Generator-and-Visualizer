...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 141.0, 281.0, 54.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 141.0, 456.0, 44.0, 44.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 277.0, 216.0, 196.0, 19.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 207.0, 91.0, 23.0 ],
					"style" : "",
					"text" : "prepend open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 141.0, 248.0, 53.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 146.75, 100.0, 23.0 ],
					"style" : "",
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 112.0, 120.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 146.0, 112.0, 120.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 138.625, 100.25, 134.75, 44.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.625, 100.25, 134.75, 44.5 ]
				}
...
, 			{
				"box" : 				{
					"id" : "obj-8",
					"items" : [ "arrinconamela.mp3", ",", "moroccan.mp3", ",", "train01.wav", ",", "train01REF.txt", ",", "train02.wav", ",", "train02REF.txt", ",", "train03.wav", ",", "train03REF.txt", ",", "train04.wav", ",", "train04REF.txt", ",", "train05.wav", ",", "train05REF.txt", ",", "train06.wav", ",", "train06REF.txt", ",", "train07.wav", ",", "train07REF.txt", ",", "train08.wav", ",", "train08REF.txt", ",", "train09.wav", ",", "train09REF.txt", ",", "train10.wav", ",", "train10REF.txt", ",", "train11.wav", ",", "train11REF.txt", ",", "train12.wav", ",", "train12REF.txt", ",", "train13MIDI.wav", ",", "train13REF.txt", ",", "youbelongwithme.mp3" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 141.0, 150.0, 130.0, 22.0 ],
					"prefix" : "D:/Program Files/Max MSP/resources/media/msp/",
					"presentation" : 1,
					"presentation_rect" : [ 141.0, 150.0, 130.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 85.0, 112.0, 43.0, 23.0 ],
					"style" : "",
					"text" : "folder"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 74.0, 110.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 146.0, 74.0, 110.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 648.0, 32.0, 496.0, 34.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 693.0, 23.0, 295.0, 62.0 ],
					"style" : "",
					"text" : "Music 158A Final Project: Music Generator"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 0 ],
					"midpoints" : [ 286.5, 239.5, 150.5, 239.5 ],
					"source" : [ "obj-9", 0 ]
				}
